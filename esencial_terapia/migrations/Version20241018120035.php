 ...
 */
final class Version20241018120035 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE detail_recipe (id INT AUTO_INCREMENT NOT NULL, remedy_recipe_id INT DEFAULT NULL, dosage INT NOT NULL, unit_of_measure VARCHAR(50) NOT NULL, INDEX IDX_C842A8ACB4CAE006 (remedy_recipe_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
